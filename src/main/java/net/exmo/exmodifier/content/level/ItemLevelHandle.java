        ...
        public static void AtUp(ExItemUpEvent event){
            ...
            if (event.entity instanceof  Player player){
              //  if (player.level.isClientSide) {
                    player.sendMessage(new TranslatableComponent("modifiler.level."+event.LevelId.id).append(" ").append(stack.getDisplayName()).append(" §r").append(new TranslatableComponent("modifiler.level.up",event.beforeLevel,event.nowLevel,event.nowLevel-event.beforeLevel)),UUID.randomUUID());
...
//                                })
    ...
    public static List<Component> getLevelItemLevelInfo(ItemStack stack, ItemLevel itemLevel) {
        ...
        if (Screen.hasShiftDown()) {
            // 添加物品等级信息
            components.add(new TranslatableComponent("modifiler.level." + itemLevel.id)
            ...
            components.add(new TranslatableComponent("modifiler.level")
                    .append(new TextComponent(levelInfo))
            ...
            components.add(new TranslatableComponent("modifiler.xp")
                    .append(new TextComponent(xpInfo))
            ...
            for (LevelAttriGether ita : _setval.attriGethers){
                ...
                components.add(new TranslatableComponent("modifiler.attri.¦").append(ita.generateTooltipBase()));
            }
