package net.exmo.exmodifier.content.modifier.block.enitty;
...
public class RefreshTableEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public RefreshTableEntity(BlockPos position, BlockState state) {
		super(RegisterOther.BlockEntityAbout.RefreshTableEntity.get(), position, state);
	}
	public static void bookAnimationTick(Level p_155504_, BlockPos p_155505_, BlockState p_155506_, RefreshTableEntity p_155507_) {
