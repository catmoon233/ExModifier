...
import net.exmo.exmodifier.content.MobEffect.*;
...
public class RegisterOther {
    public static class EffectAbout{
        ...
        public static final RegistryObject<PotionPowerEffect> POTION_POWER_EFFECT = REGISTRY.register("potion_power_effect", PotionPowerEffect::new);
    }
