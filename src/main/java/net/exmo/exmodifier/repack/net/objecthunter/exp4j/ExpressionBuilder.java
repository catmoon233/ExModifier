...
package net.exmo.exmodifier.repack.net.objecthunter.exp4j;
...
import net.exmo.exmodifier.repack.net.objecthunter.exp4j.shuntingyard.ShuntingYard;

/**
 * Factory class for {@link net.exmo.exmodifier.repack.net.objecthunter.exp4j.Expression} instances. This class is the main API entrypoint. Users should create new
 * {@link net.exmo.exmodifier.repack.net.objecthunter.exp4j.Expression} instances using this factory class.
 */
public class ExpressionBuilder {
    ...
    /**
     * Build the {@link net.exmo.exmodifier.repack.net.objecthunter.exp4j.Expression} instance using the custom operators and functions set.
     * @return an {@link net.exmo.exmodifier.repack.net.objecthunter.exp4j.Expression} instance which can be used to evaluate the result of the expression
     */
    public net.exmo.exmodifier.repack.net.objecthunter.exp4j.Expression build() {
