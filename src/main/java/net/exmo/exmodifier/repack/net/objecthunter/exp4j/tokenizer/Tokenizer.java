...
import net.exmo.exmodifier.repack.net.objecthunter.exp4j.function.Functions;
import net.exmo.exmodifier.repack.net.objecthunter.exp4j.operator.Operator;
import net.exmo.exmodifier.repack.net.objecthunter.exp4j.operator.Operators;
import net.exmo.exmodifier.repack.net.objecthunter.exp4j.tokenizer.*;
...
public class Tokenizer {
    ...
    private net.exmo.exmodifier.repack.net.objecthunter.exp4j.tokenizer.Token lastToken;
    ...
    public net.exmo.exmodifier.repack.net.objecthunter.exp4j.tokenizer.Token nextToken(){
        ...
        if (Character.isDigit(ch) || ch == '.') {
            if (lastToken != null) {
                if (lastToken.getType() == net.exmo.exmodifier.repack.net.objecthunter.exp4j.tokenizer.Token.TOKEN_NUMBER) {
                    throw new IllegalArgumentException("Unable to parse char '" + ch + "' (Code:" + (int) ch + ") at [" + pos + "]");
                } else if (implicitMultiplication && (lastToken.getType() != net.exmo.exmodifier.repack.net.objecthunter.exp4j.tokenizer.Token.TOKEN_OPERATOR
                        && lastToken.getType() != net.exmo.exmodifier.repack.net.objecthunter.exp4j.tokenizer.Token.TOKEN_PARENTHESES_OPEN
                        && lastToken.getType() != net.exmo.exmodifier.repack.net.objecthunter.exp4j.tokenizer.Token.TOKEN_FUNCTION
                        && lastToken.getType() != net.exmo.exmodifier.repack.net.objecthunter.exp4j.tokenizer.Token.TOKEN_SEPARATOR)) {
            ...
            if (lastToken != null && implicitMultiplication &&
                    (lastToken.getType() != net.exmo.exmodifier.repack.net.objecthunter.exp4j.tokenizer.Token.TOKEN_OPERATOR
                            && lastToken.getType() != net.exmo.exmodifier.repack.net.objecthunter.exp4j.tokenizer.Token.TOKEN_PARENTHESES_OPEN
                            && lastToken.getType() != net.exmo.exmodifier.repack.net.objecthunter.exp4j.tokenizer.Token.TOKEN_FUNCTION
                            && lastToken.getType() != net.exmo.exmodifier.repack.net.objecthunter.exp4j.tokenizer.Token.TOKEN_SEPARATOR)) {
                // insert an implicit multiplication token
    ...
    private net.exmo.exmodifier.repack.net.objecthunter.exp4j.tokenizer.Token parseArgumentSeparatorToken(char ch) {
        this.pos++;
    ...
    private net.exmo.exmodifier.repack.net.objecthunter.exp4j.tokenizer.Token parseParentheses(final boolean open) {
        if (open) {
    ...
    private net.exmo.exmodifier.repack.net.objecthunter.exp4j.tokenizer.Token parseFunctionOrVariable() {
        final int offset = this.pos;
        int testPos;
        int lastValidLen = 1;
        net.exmo.exmodifier.repack.net.objecthunter.exp4j.tokenizer.Token lastValidToken = null;
        int len = 1;
    ...
    private net.exmo.exmodifier.repack.net.objecthunter.exp4j.tokenizer.Token parseOperatorToken(char firstChar) {
        final int offset = this.pos;
        int len = 1;
    ...
    private Operator getOperator(String symbol) {
        ...
        if (op == null && symbol.length() == 1) {
            ...
            if (lastToken == null) {
                ...
                if (lastTokenType == net.exmo.exmodifier.repack.net.objecthunter.exp4j.tokenizer.Token.TOKEN_PARENTHESES_OPEN || lastTokenType == net.exmo.exmodifier.repack.net.objecthunter.exp4j.tokenizer.Token.TOKEN_SEPARATOR) {
                    argc = 1;
                } else if (lastTokenType == net.exmo.exmodifier.repack.net.objecthunter.exp4j.tokenizer.Token.TOKEN_OPERATOR) {
