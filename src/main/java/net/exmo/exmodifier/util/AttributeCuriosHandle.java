    ...
    private static class ForgeBusEvents {
        ...
        public static void RenderCustomCuriosAttributes(ItemTooltipEvent event){
            ...
            if (!attributeModifiers.isEmpty()){
                ...
                event.getToolTip().add(new TranslatableComponent("attribute.curios.tooltip").withStyle(ChatFormatting.GOLD));
        ...
        public static void RenderTooltips(ItemTooltipEvent event) {
            if (event.getItemStack().getItem() instanceof AttributeCurios a ) {
                if (a.CoolDown !=0){
                    event.getToolTip().add(new TextComponent("attribute.curios.cooldown").append(new TextComponent("§l§e " + a.CoolDown*0.05+ " " ).append(new TextComponent("attribute.curios.cooldown.second"))));
                }
                ...
                if (a.Star_rating != 0) {
                    ...
                    event.getToolTip().add(new TextComponent("§l§e" + starString));
                }
                event.getToolTip().add(new TextComponent(""));
            if (a.customTooltips.isEmpty() ) event.getToolTip().add(new TranslatableComponent("attribute.curios.tooltip").withStyle(ChatFormatting.GOLD));
...
//                            }
                            ...
                            event.getToolTip().add(new TextComponent("\u00a79" + as + amouts + as1 + " ").append(new TextComponent((attrGether.attribute.getDescriptionId()))).withStyle(ChatFormatting.BLUE));
        ...
        public static void OnCurioChange(CurioChangeEvent event) {
            ...
            if (event.getFrom().getItem() instanceof AttributeCurios a) {
                if (attributeCurios.contains(a)) {
                    if (a.attrGethers !=null) {
                        for (AttrGether attrGether : a.attrGethers) {
                            if (attrGether!=null)      EntityAttrUtil.entityAddAttrTF(attrGether, (LivingEntity) event.getEntity(), EntityAttrUtil.WearOrTake.TAKE);
                        }
                    }
                }
            }
            if (event.getTo().getItem() instanceof AttributeCurios a) {
                if (attributeCurios.contains(a)) {
                    if (a.attrGethers !=null) {
                        ...
                        for (AttrGether attrGether : a.attrGethers) {
                            if (attrGether !=null) EntityAttrUtil.entityAddAttrTF(attrGether, (LivingEntity) event.getEntity(), EntityAttrUtil.WearOrTake.WEAR);
                        }
                    }
                }
            }
